...
const Header: React.FC<{ resolvedMode: ResolvedColorMode, toggleColorMode(): void }> = ({ resolvedMode, toggleColorMode }) => {
  return (
    <Box textAlign="center" position="relative">
      ...
      <Text color={resolvedMode === 'dark' ? 'gray.300' : 'gray.600'} fontSize={{ base: 'sm', md: 'md' }}>
        Playground with version: <Code>1.0.0-beta.3</Code>
      </Text>
    </Box>
  );
};
