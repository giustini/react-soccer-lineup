...
<LiveDemo
  ...
  homeTeam={{
    squad: {
      ...
      df: [
        { number: 2, name: 'Vrsaljko', offset: { x: 20 } },
        { number: 6, name: 'Lovren' },
        { number: 21, name: 'Vida' },
        { number: 3, name: 'Strinić', offset: { x: 20 } }
      ],
      cdm: [
      ...
      cm: [
        { number: 18, name: 'Rebić', offset: { x: 20 } },
        { number: 10, name: 'Modrić' },
        { number: 4, name: 'Perišić', offset: { x: 20 } },
      ],
      fw: [
...
## Sporting de Portugal 2002 / 2003
...
<LiveDemo
  ...
  homeTeam={{
    squad: {
      ...
      df: [
        { number: 22, name: 'Beto', offset: { x: 20 } },
        { number: 15, name: 'Contreras' },
        { number: 4, name: 'Quiroga' },
        { number: 23, name: 'Rui Jorge', offset: { x: 20 } }
      ],
      cdm: [
        { number: 17, name: 'Bento' },
      ],
      cm: [
        { number: 20, name: 'Quaresma', offset: { x: 20 } },
        { number: 30, name: 'Toñito' },
        { number: 28, name: 'Cristiano Ronaldo', offset: { x: 20 } }
      ],
      fw: [
        null,
