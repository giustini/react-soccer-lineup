          ...
          <Card.Body>
            <VStack gap={4} align='stretch'>
              <Box display='flex' gap={4}>
                <Badge mb={2}>responsive size</Badge>
                <Badge mb={2}>circles pattern</Badge>
                <Badge mb={2}>color #03A6A1</Badge>
              </Box>
              <Heading size='sm'>Asymmetric formations</Heading>
        ...
        <Card.Root>
          <Card.Body>
            <VStack gap={4} align='stretch'>
              <Box display='flex' gap={4}>
                <Badge mb={2}>responsive size</Badge>
                <Badge mb={2}>color #C1785A</Badge>
                <Badge mb={2}>5 players</Badge>
              </Box>
        ...
        <Card.Root>
          <Card.Body>
            <VStack gap={4} align='stretch'>
              <Box display='flex' gap={4}>
                <Badge mb={2}>responsive size</Badge>
                <Badge mb={2}>squares pattern</Badge>
                <Badge mb={2}>color #327d61</Badge>
                <Badge mb={2}>with names</Badge>
              </Box>
